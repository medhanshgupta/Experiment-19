...
## Theory: 
This experiment focuses on Advanced and Interactive Data Visualization, specifically utilizing the Plotly library to create dynamic charts.
Unlike static plots, interactive visualizations allow users to hover over data points for more detail, zoom in on specific regions,   
